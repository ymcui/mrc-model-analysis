...
def attention_layer(from_tensor,
  ...
  if mask_zone is not None:
    ...
    to_mask_b_t = tf.cast(tf.reshape(att_mask, [batch_size, to_seq_length, 1]), tf.float32)

    mask_c = broadcast_ones * to_mask_b
    if mask_zone == "p2" or mask_zone == "q2":
      mask_c = (to_mask_b_t * to_mask_b) * mask_c
    elif mask_zone == "p2q" or mask_zone == "q2p":
      mask_c = (1 - to_mask_b_t * to_mask_b) * mask_c
